...
custom_imports = dict(
    imports=[
        ...
        'mmseg.models.segmentors.cls_only_segmentor',
    ],
    allow_failed_imports=False,
)

model = dict(
    type='ClsOnlySegmentor',
...
val_evaluator = dict(type='ClsAccuracy', topk=(1,), prefix='cls')
...
work_dir = './work_dirs/bisenet_cls_only_strict_fixed'
